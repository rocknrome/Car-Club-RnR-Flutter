...
class _TripAddPageState extends State<TripAddPage> {
  ...
  Future<void> _addTrip() async {
    ...
    final Map<String, dynamic>? beginPoint =
        _beginPointController.text.isNotEmpty
            ? jsonDecode(_beginPointController.text)
            : null;
    final Map<String, dynamic>? endPoint = _endPointController.text.isNotEmpty
        ? jsonDecode(_endPointController.text)
        : null;
    final String imageUrl = _imageUrlController.text.trim();

    final Trip newTrip = Trip(
      id: null, // Set id to null when it's generated by the server
      title: title,
